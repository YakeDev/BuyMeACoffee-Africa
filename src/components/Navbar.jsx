...
const Navbar = () => {
  return (
    <header className="sm:w-[80%] md:w-[90%] lg:w-[70%] xl:w-[80%] 2xl:w-[50%] mx-auto">
      <nav className="flex items-center justify-between py-2 border border-zinc-950/5 bg-zinc-950/2 rounded-2xl px-3 mt-4">
