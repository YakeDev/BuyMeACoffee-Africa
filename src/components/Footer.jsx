                ...
                <div className="sm:w-[80%] md:w-[90%] lg:w-[70%] xl:w-[80%] 2xl:w-[50%] mx-auto">
                        ...
                        <div className="grid grid-cols-2 gap-6 text-sm">
                            <div className="flex flex-col gap-2">
                                ...
                                <ul className="flex flex-col gap-2">
                                    <li>
                                        <Link to="/about" className="font-medium text-black/60 capitalize hover:text-yellow-600 transition">à propos</Link>
                                    </li>
                                    <li>
                                        <Link to="/blog" className="font-medium text-black/60 capitalize hover:text-yellow-600 transition">blog</Link>
                                    </li>
                                    <li>
                                        <Link to="/dev" className="font-medium text-black/60 capitalize hover:text-yellow-600 transition">dévéloppeurs</Link>
                                    </li>
                                    <li>
                                        <Link to="/team" className="font-medium text-black/60 capitalize hover:text-yellow-600 transition">équipe</Link>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <ul className="flex flex-col gap-2">
                                    ...
                                    <li>
                                        <Link to="/help" className="font-medium text-black/60 capitalize hover:text-yellow-600 transition">aide</Link>
                                    </li>
                                    <li>
                                        <Link to="/privacy" className="font-medium text-black/60 capitalize hover:text-yellow-600 transition">politique de confidentialité</Link>
                                    </li>
                                    <li>
                                        <Link to="/terms" className="font-medium text-black/60 capitalize hover:text-yellow-600 transition">terms d'utilisation</Link>
                                    </li>
                                    <li>
                    ...
                    <div className="flex items-center justify-between mt-10 text-sm border-t border-zinc-950/5 pt-4">
                        ...
                        <div className="flex gap-1 justify-end items-center">
                            ...
                            <Link to="/" className="flex items-center gap-1 hover:text-yellow-500 transition duration-300 underline underline-offset-2">
