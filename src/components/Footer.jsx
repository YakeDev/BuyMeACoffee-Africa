...
const Footer = () => {
	...
	return (
		<footer className='border-t border-[rgba(107,62,38,0.14)] bg-[rgba(245,237,230,0.9)] backdrop-blur-xl'>
			<div className='mx-auto flex w-full max-w-6xl flex-col gap-12 px-6 pt-16 pb-8 text-[color:rgba(43,27,18,0.72)]'>
					...
					<div className='space-y-6'>
						<Link
							...
							<div className='flex flex-col'>
								...
								<span className='text-base -mt-1 font-semibold text-[var(--color-espresso)]'>
									Africa
								</span>
							</div>
						</Link>
