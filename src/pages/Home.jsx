        ...
        <section className="mx-auto mt-20 w-full max-w-5xl px-6">
          <div className="surface-card rounded-[2.5rem] p-8">
            <div className="mb-6 flex items-center gap-2 text-xs uppercase tracking-[0.4em] text-[var(--color-latte)]">
              <span className="size-2 rounded-full bg-[rgba(107,62,38,0.6)]" />
              <span className="size-2 rounded-full bg-[rgba(225,169,72,0.7)]" />
              <span className="size-2 rounded-full bg-[rgba(200,159,133,0.8)]" />
            </div>
            <div className="overflow-hidden rounded-2xl border border-[rgba(107,62,38,0.12)] shadow-lg shadow-[rgba(43,27,18,0.12)]">
              <img
                src={Preview}
                alt="Preview"
                width={1400}
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {steps.map((step) => (
              ...
              >
                ...
                <div className="overflow-hidden rounded-xl border border-[rgba(107,62,38,0.08)] bg-[rgba(245,237,230,0.7)] p-4 shadow-inner shadow-[rgba(107,62,38,0.08)]">
                  <img src={step.image} alt="" width={300} height={100} className="w-full object-contain" />
                </div>
              </div>
            ))}
          </div>
